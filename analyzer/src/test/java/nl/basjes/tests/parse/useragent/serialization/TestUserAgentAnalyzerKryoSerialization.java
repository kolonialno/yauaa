...
class TestUserAgentAnalyzerKryoSerialization extends AbstractAnalyzerSerializationTest<UserAgentAnalyzer> {
    ...
    @Override
    UserAgentAnalyzer create() {
        UserAgentAnalyzer.UserAgentAnalyzerBuilder builder = UserAgentAnalyzer.newBuilder().withCache(1234);
