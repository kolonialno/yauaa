...
package nl.basjes.tests.parse.useragent.parse;
...
class TestUserAgentFlattening {
    ...
    void testFlatteningSpecialCases() {
        ...
        validateUserAgent(
            ...
            ,"agent.(1)product.(1)comments.(5)entry.(2)product.(1)name=\"Build\""
            ,"agent.(1)product.(1)comments.(5)entry.(2)product.(1)version=\"Deode\""
            ,"agent.(1)product.(1)comments.(5)entry.(2)product.(2)version=\"4.0.7\""
            ,"agent.(2)product=\"AppleWebKit/534.30 (KHTML,like Gecko)\""
            ,"agent.(2)product.(1)name=\"AppleWebKit\""
            ,"agent.(2)product.(1)version=\"534.30\""
            ,"agent.(2)product.(1)comments=\"(KHTML,like Gecko)\""
