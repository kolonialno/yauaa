...
public class StepIsNotInLookupContains extends Step {

    private final String          lookupName;
    private final HashSet<String> lookupKeys;

    @SuppressWarnings("unused") // Private constructor for serialization systems ONLY (like Kryo)
    private StepIsNotInLookupContains() {
        lookupName = null;
        lookupKeys = null;
    }

    public StepIsNotInLookupContains(String lookupName, Map<String, String> lookup) {
    ...
    public String toString() {
        return "IsNotInLookupContains(@" + lookupName + ")";
    }
